...
const accessCards: AccessCard[] = [
  ...
  {
    title: 'Veterinaria',
    description: 'Pacientes, agenda, registros medicos y seguimiento clinico.',
    action: 'Ingresar como veterinaria',
    href: '/login?role=VET',
    icon: 'vet',
  },
  {
    title: 'Administrador',
    description: 'Panel operativo, veterinarias, propietarios, pacientes y alertas.',
